...
/////// My Own Work
const drop = document.querySelector('.comingdown');
const arrow = document.querySelector('.arrowdown');

arrow.onclick = function (ev) {
  if (!ev.target.matches('.arrowdown')) {
...
//message.textContent = 'We use cookied for improved functionality and analutics.';
message.innerHTML =
